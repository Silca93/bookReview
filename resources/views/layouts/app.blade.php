...
<head>
  ...
  <style type="text/tailwindcss">
    ...
    .clearBtn {
      @apply bg-slate-800 rounded-md px-4 py-2 text-center font-medium text-slate-100 shadow-sm ring-1 ring-slate-700/10 hover:bg-slate-50 hover:text-black h-10;
    }
    ...
    .filter-container {
      @apply mb-4 flex  space-x-2 rounded-md bg-slate-700 p-2;
    }
